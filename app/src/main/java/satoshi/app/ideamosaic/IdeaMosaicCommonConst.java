...
public class IdeaMosaicCommonConst {
	...
	//リクエストコード
	private static int RequestCode_LISTVIEW_IDEA = 10;
	private static int RequestCode_MATRIX_IDEA = 11;
	private static int RequestCode_LISTVIEW_SEARCH = 20;
	private static int RequestCode_LISTVIEW_TUTORIAL = 30;

	//<<ADD 2013/08/09
	private static int RequestCode_LISTVIEW_MINDMAP = 40;
	private static int RequestCode_LISTVIEW_MINDMAPCREATE = 41;
	//END>>

	//DBの定義
	private final static String DB_NAME = "IdeaMosaic.db";
	private final static String str_DB_ListTable = "im_ListTable";
	private final static String str_DB_IdeaMosaic = "IdeaMosaic";
	private final static String str_DB_IMColor = "IMColor";
	private final static String str_DB_BS = "BrainStorming";
	private final static int DB_VERSION = 1;

	//データベースのストラクチャ
	private final static String[] brainstroming_fieldNames = {"brainstorming"};
	private final static String[] brainstroming_fieldType = {"integer"};

	//データベースのストラクチャ
	private final static String[] Listtable_fieldNames = {"table_name", "table_id", "time_stamp"};
	private final static String[] Listtable_fieldTypes = {"text not null","integer primary key", "text not null"};

	//データベースのストラクチャ
	private final static String[] Matrix_fieldNames = {
		"Matrix0",			 				//ボタン：１行１列目			0
		"Matrix1", 							//ボタン：１行２列目			1
		"Matrix2",							//ボタン：１行３列目			2
		"Matrix3",							//ボタン：２行１列目			3
	...
	private final static String[] Matrix_fieldTypes = {
		"text",										//0
		"text",										//1
		"text",										//2
		"text",										//3
	...
	//データベースのストラクチャ
	private final static String[] MatrixButtonColor_fieldNames = {
	...
	private final static String[] MatrixButtonColor_fieldTypes = {
		"text",										//0
		"text",										//1
		"text",										//2
		"text",										//3
	...
	private final static int INT_List_Index_TableName = 0;
	private final static int INT_List_Index_TableID = 1;
	private final static int INT_List_Index_TimeStamp = 2;

	//データベースストラクチャのインデックス(Matrix)
	private final static int INT_Matrix_Index_Mat0 = 0;
	private final static int INT_Matrix_Index_Mat1 = 1;
	private final static int INT_Matrix_Index_Mat2 = 2;
	private final static int INT_Matrix_Index_Mat3 = 3;
	private final static int INT_Matrix_Index_Mat4 = 4;
	private final static int INT_Matrix_Index_Mat5 = 5;
	private final static int INT_Matrix_Index_Mat6 = 6;
	private final static int INT_Matrix_Index_Mat7 = 7;
	private final static int INT_Matrix_Index_Mat8 = 8;
	private final static int INT_Matrix_Index_ID = 9;
	private final static int INT_Matrix_Index_TimeStamp = 10;

	//テキスト入力の最大文字数
	private final static int  NameMaxLength_IdeaBookName = 20;
	private final static int  NameMaxLength_MatrixWord = 20;

	//R.id.***をリスト化したものを定義する
	private final static ArrayList<Integer> alist_RIDButton = new ArrayList<Integer>();

	//R.color.***をリスト化したものを定義する
	private final static ArrayList<Integer> alist_RColor = new ArrayList<Integer>();

	//色の名前をリスト化するものを定義する
	private final static ArrayList<String> alist_ColorName = new ArrayList<String>();

	//オプションボタンのインデックス
	private final int OPTION_SELECT_0 = 0;
	private final int OPTION_SELECT_1 = 1;
	private final int OPTION_SELECT_2 = 2;
	private final int OPTION_SELECT_3 = 3;
	private final int OPTION_SELECT_4 = 4;
	private final int OPTION_SELECT_5 = 5;
	private final int OPTION_SELECT_6 = 6;
...
/*--					Getter and Sette					sr--*/
	 ...
	 * @return
	 */
	public String createInnerTableName(int int_listid){
		return getstrDbIdeamosaic() + "_" + String.valueOf(int_listid);
	}
